...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='get witness info', epilog='Report bugs to https://github.com/bitfag/golos-witness-tools/issues'
    )
    parser.add_argument('-c', '--config', default='./update_witness.yml', help='specify custom path for config file')
    parser.add_argument('witness', help='witness name to get info about')
